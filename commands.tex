...
% ── Macros redefinies dans report.tex (defaults) ────────────────────────
\providecommand{\EUR}{\texteuro}          % symbole euro, usage : \EUR{}2.5 bn
\providecommand{\spacinghere}{1cm}        % espacement vertical, redefini par page
