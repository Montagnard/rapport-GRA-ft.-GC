...
\newcommand{\rot}[1]{\rotatebox[origin=c]{90}{\scriptsize #1}}
\newcommand{\yes}{Yes}
\newcommand{\no}{--}
\newcommand{\limi}{Lim.}
\newcommand{\form}{Form.}
...
\author{Gunther Capelle-Blancard\thanks{Université Paris 1 Panthéon-Sorbonne (\textit{Centre d'Economie de la Sorbonne} \& CNRS). gunther.capelle-blancard@univ-paris1.fr}}
\date{September, 2026}
\maketitle
...
The following sections provide the detailed background supporting this proposal. They first present the design and rationale of the equity transfer tax, before reviewing existing national policies and the earlier European FTT project. They then set out the revenue-estimation methodology and Member State-level results, respond to common objections, review public opinion, and finally discuss possible extensions, notably to intraday transactions.
...
\section{A pragmatic design for an EU FTT}

FTTs are neither new nor untested. They have existed for centuries and remain in force in several major financial centres. The relevant question is therefore not whether an FTT can exist, but how it should be designed \citep{CapelleBlancard2024}.
...
The most important of these design features is the issuance principle. Under this principle, the tax applies to transactions in shares issued by companies incorporated in the taxing jurisdiction, regardless of the residence or nationality of the investor and regardless of where the transaction takes place. This is the logic underpinning the UK stamp duty and the French FTT. It is crucial for enforceability: the tax is linked to the legal transfer of ownership of securities, not to the location of the trading platform or intermediary. This design considerably limits avoidance opportunities and explains why such taxes can be maintained even in highly internationalised financial markets \citep{CapelleBlancardPersaud2025}.\footnote{The possibility that some new firms might incorporate outside the EU to avoid the tax cannot be entirely ruled out, but it is unlikely to be a major margin of avoidance. The tax would apply only to secondary-market transfers of shares, not to primary issuance, and its rate would be very low relative to the legal, fiscal, regulatory and governance costs associated with incorporating outside the firm's main economic area. For most firms, access to investors, legal certainty, listing conditions and corporate taxation are far more important than a modest tax on future share transactions.}


Administrative and legal feasibility is a central reason for choosing this design. The proposal does not require creating a tax on all financial transactions from scratch. It builds on existing settlement, reporting and securities-registration infrastructures. Because the taxable event is the legal transfer of ownership of issued shares, collection can rely on the institutions that already record, settle or report these transfers. From a legal perspective, the key issues are therefore the definition of the taxable event, the territorial connecting factor, the scope of exemptions and the organisation of reporting and collection obligations \citep{Correia2025}.

A public reporting architecture would have important advantages. Rather than relying solely on private intermediaries to aggregate and transmit taxable transactions, the EU could require standardised reporting to the relevant tax authority, market supervisor or a designated public repository. This would create a more complete and uniform record of taxable equity transfers across Member States. It would also improve the traceability of transactions, facilitate administrative control, and reduce the risk that differences in national reporting systems create loopholes or uneven enforcement. In this sense, the collection mechanism would not merely be an administrative tool; it would also strengthen market transparency and supervisory capacity.

Harmonisation would still be needed at EU level, but the administrative and legal challenge is much more limited than for a comprehensive FTT covering derivatives, foreign exchange or crypto-assets.

Beyond the fiscal case, the proposal also has an established economic rationale. Keynes, and later Tobin and Stiglitz, argued in different contexts that very short-term financial trading may generate private gains without always contributing to the social usefulness of financial markets. The point is not to obstruct market functioning, but to ensure that a modest share of the gains from highly liquid financial-market activity contributes to public revenue, while discouraging the most socially unproductive forms of short-term trading.
...
Overall, the international landscape is heterogeneous. Some instruments, such as the UK stamp duty, the French FTT or the Spanish FTT, are close to an issuance-based equity transfer tax. Others are broader securities transaction taxes, stamp duties or financial transaction taxes applying to different instruments or market segments.\footnote{Two additional cases are worth mentioning, although they are not directly comparable to the core equity-transfer taxes discussed above. Finland is sometimes included in broad inventories of securities transfer taxes because it applies a relatively high transfer tax to corporate shares and other securities. However, listed shares traded on the stock exchange are usually exempt,
so the Finnish case should not be interpreted as a standard equity-market FTT. The United States provides a different example: Section 31 fees are a regulatory transaction fees used to finance the Securities and Exchange Commission. They are politically relevant because they show that even the US system accepts transaction-based levies on securities markets when they are linked to market supervision.} 
...
A specific political-economy issue arises for Member States that already levy such taxes. Their likely reaction would depend on whether an EU-wide FTT is designed as a replacement for existing national schemes or as a harmonised EU component built on top of, or alongside, them. These countries are unlikely to object to the principle of taxing equity transactions, since they already do so. However, they may be reluctant to transfer existing national revenues entirely to the EU budget. %This reinforces the need to distinguish between gross EU-wide revenue potential and net additional resources for the MFF.

There is no fully neutral solution to this problem. Temporary retention of national receipts would only postpone the adjustment, while country-specific credits could weaken the equal treatment of Member States. % TODO
A more coherent response would be to complement the EU own resource with national extensions to offset the loss of revenue (to the EU budget) for countries that already tax financial transactions. %separate the core EU own resource from possible complementary national or EU-wide extensions. 
The core EU instrument would remain a harmonised, issuance-based tax on equity ownership transfers. This is the simplest and most tested design, and the one most consistent with existing successful schemes.

At the same time, Member States that already levy an FTT would %could be allowed, or encouraged within a harmonised framework, to 
broaden their national schemes beyond the core equity-transfer base, notably towards intraday equity transactions or equity derivatives. Such extensions would make economic sense: the current French-type design leaves many very short-term transactions outside the effective tax base, and equity derivatives may be close substitutes for taxed share transactions. They could therefore provide additional national revenue and reduce avoidance margins. %However, they should be treated as optional or later-stage extensions, not as part of the core EU own resource, because they raise greater operational, valuation and market-making issues.

Even independently of the own-resource debate, greater harmonisation of national FTTs within the EU would be desirable. France, Italy and Spain already operate broadly comparable equity-FTT schemes, and a similar framework could in principle be extended to other Member States, including Germany. Such harmonisation would reduce fragmentation, clarify the tax base, and strengthen the case for a future EU-level own resource.
...
%\newgeometry{bottom=-3cm, left=0cm}
\vspace*{-1.2cm}
\begingroup
\scriptsize
...
\begin{longtable}{L{2.2cm} C{0.65cm} C{0.75cm} C{0.75cm} L{2.1cm} L{2.5cm} L{12.55cm}}
...
\multicolumn{7}{l}{\textit{Panel A. Europe}}\\
\midrule
...
& \no
& \no
& \makecell[tl]{0.4\%\\from 2025}
& \makecell[tl]{EUR 1.86bn\\2024}
& Issuance-based tax on acquisitions of shares issued by large French companies. The 2024 revenue refers to the former 0.3\% rate. The formal HFT and naked sovereign CDS components generate little or no meaningful revenue. \\

Italy
& \yes
& \no
& \yes
& \makecell[tl]{0.2--0.4\%\\equity}
& \makecell[tl]{c. EUR 0.5bn\\indicative}
& Broader than the French design, with equity transfers, derivatives and a formal HFT component. The revenue figure should be treated cautiously pending a fully comparable official series. \\
...
& 0.2\%
& n.a.
& Modern equity FTT introduced in 2021. Close to the French model, with a tax on acquisitions of shares in large Spanish companies. \\

Belgium
& \yes
& \yes
& \no
& \makecell[tl]{0.12--\\1.32\%}
& \makecell[tl]{c. EUR 0.43bn\\2023}
& Tax on stock-exchange transactions. The base is broader than equity alone and depends on the type of instrument. Less close to a pure issuance-based equity transfer tax. \\
...
& 1.5\%
& n.a.
& Transfer tax on corporate shares and other securities, but listed shares traded on the stock exchange are usually exempt. The high headline rate is therefore not directly comparable to equity-market FTTs such as the UK, French, Italian or Spanish schemes. \\
...
& \limi
& 1\%
& \makecell[tl]{c. EUR 0.54bn\\2025}
& Stamp-duty-type tax on transfers of shares, stocks and marketable securities. Close in spirit to the UK model, but with a higher headline rate. \\
...
& \no
& 0.5\%
& \makecell[tl]{c. EUR 5.1bn\\GBP 4.32bn\\2024--25}
& Main benchmark for an issuance-based equity transfer tax. The tax is attached to UK-issued shares and collected through established settlement and registration mechanisms. \\

Switzerland
& \yes
& \yes
& \no
& \makecell[tl]{0.15\% /\\0.30\%}
& \makecell[tl]{c. EUR 1.6bn\\CHF 1.53bn\\2025}
& Securities transfer stamp tax on purchases and sales of Swiss and foreign securities when a Swiss securities dealer acts as contracting party or intermediary. \\

\midrule
\multicolumn{7}{l}{\textit{Panel B. Rest of the world}}\\
\midrule
...
& \no
& \makecell[tl]{0.1\% +\\0.1\%}
& \makecell[tl]{c. EUR 6.2bn\\HKD 52bn\\2024--25}
& Stamp duty on both purchase and sale notes. Useful benchmark because it raises substantial revenue in a highly active international equity market. \\

South Korea
& \yes
& \no
& \yes
& \makecell[tl]{c. 0.20\%\\listed;\\0.35\% other}
& \makecell[tl]{c. EUR 3.3bn\\KRW 4.8tn\\2024}
& Securities transaction tax on transfers of Korean shares. Rates differ by market segment and changed repeatedly. Derivatives are covered by a separate capital gain tax.\\
...
& \no
& 0.05\%
& \makecell[tl]{c. EUR 16bn\\RMB 127.6bn\\2024}
& Stamp duty on stock transactions, currently levied on the seller only. Revenue is very large in absolute terms. Difficult to have detailed information. \\
...
& \yes
& 0.3\%
& \makecell[tl]{c. EUR 8.3bn\\NTD 288bn\\2024}
& Securities transaction tax on sellers of securities. Bond taxation is limited or suspended for some instruments; derivatives are covered by a separate futures transaction tax. \\

India
& \yes
& \no
& \yes
& \makecell[tl]{0.1\% delivery;\\0.025\% intraday;\\derivatives vary}
& n.a.
& Securities transaction tax on exchange-traded equity and derivatives. The design distinguishes delivery-based equity trades, intraday equity trades and derivatives. \\
...
& 0.25\%
& n.a.
& Securities transfer tax on transfers of listed and unlisted securities. \\

United States
& \limi
& \no
& \limi
& \makecell[l]{USD 20.60\\per million\\from Apr. 2026}
& \makecell[l]{USD 2.15bn\\FY2026 target}
& Section 31 fee on covered securities sales, paid by exchanges and FINRA/SROs and generally passed through to broker-dealers and customers. This is a regulatory transaction fee used to finance the SEC. Politically relevant because it shows that transaction-based levies exist even in the US market. \\
...
\begin{flushleft}
\scriptsize
Notes: The table is illustrative rather than exhaustive. ``Equity'' refers to taxes on purchases, sales or transfers of shares or comparable equity securities. ``Bonds/oth.'' refers to bonds or other securities. ``Deriv.'' refers to derivatives. A dash means that the instrument is not part of the main effective tax base. ``Form.'' indicates that a formal provision exists, but that it is not a major component of the effective tax base or revenue. Revenue figures are approximate euro equivalents and are not directly comparable across jurisdictions, since tax bases, exemptions, fiscal years, exchange rates and budgetary classifications differ. ``n.a.'' means that no sufficiently comparable revenue figure is reported here, not that the tax raises no revenue. ``Lim.'' indicates that the instrument exists only for a limited segment of the relevant market, or that it is not directly comparable to a standard equity-market FTT.
\end{flushleft}
...
The lesson for the present proposal is not that an EU FTT is impossible, but that its design must avoid the main pitfalls of the 2011--2013 project. The proposal examined here is therefore much less ambitious than the earlier European project. It does not seek to tax all financial instruments, all markets and all financial actors. It does not include bonds, derivatives or foreign-exchange transactions at the adoption stage. Nor does it attempt to tax all gross intraday transactions. Instead, it focuses on equity transfers, following the logic of existing national schemes such as the British stamp duty and the French FTT.
...
The same implicit tax ratio is then applied to the equity trading volume of each Member State.\footnote{For some Member States, including Luxembourg, ESMA reports no equity trading volume in the dataset used for this exercise. These entries are therefore kept at zero for consistency with the ESMA data. This should not be interpreted as meaning that these countries have no financial-market activity. Rather, their recorded equity trading volumes are either absent from the ESMA table or extremely small in alternative sources. For Luxembourg, for example, World Bank and WFE-based figures are only around EUR 36--37 million in 2024, which would imply a negligible revenue estimate under the methodology used here.} The estimate at a 0.3\% statutory rate is given by:
...
\footnote{As an illustrative international benchmark, applying the same implicit revenue ratio to WFE equity trading volumes gives much larger orders of magnitude for major non-EU markets: approximately EUR 116 billion for the United States, EUR 6.9 billion for Japan, EUR 28.6 billion for China, and EUR 178 billion at the world level. These figures should be interpreted with great caution. They are not directly comparable with the ESMA-based Member State estimates and are provided only as indicative orders of magnitude. For the EU, WFE data are not used for revenue estimation because they produce a much lower aggregate than ESMA and do not provide a satisfactory allocation of trading activity across Member States.}
...
The political design should therefore avoid treating the distribution of recorded trading volumes as a distribution of national contributions. A more robust presentation would distinguish three issues: the place where transactions are recorded, the securities that fall within the legal scope of the tax, and the final allocation of revenues to the EU budget. For Member States with large trading platforms but no existing FTT, the central point is that the tax would not be a charge on the national budget, but a levy on financial-market transactions involving EU-issued shares. 
The treatment of existing national FTT revenues is a separate political-design issue, discussed above, and should not be inferred from the distribution of recorded trading volumes.
...
This objection is partly correct but often overstated. An FTT increases the cost of trading and is therefore expected to reduce trading volumes \citep{IMF2010}. The key point, however, is that trading volume and useful liquidity are not the same thing. A reduction in turnover does not necessarily imply that investors are unable to trade at reasonable cost, especially if the tax is low, applies only to equity ownership transfers, and preserves exemptions for genuine market-making activities.

The evidence on the French FTT is particularly useful in this respect. \cite{ColliardHoffmann2017} show that the tax reduced trading activity and changed market composition, but they do not find evidence of a collapse in market quality. In particular, the French experience does not support the claim that a low-rate equity FTT necessarily destroys liquidity or increases volatility. The relevant lesson is therefore more nuanced than either side of the debate sometimes suggests: trading volumes may decline, but this does not automatically translate into a significant deterioration of useful liquidity.\footnote{Moreover, the literature on individual investors  shows that more frequent trading often reduces net performance \citep{DeBondtThaler1995, Shleifer2000,Odean1999,BarberOdean2000, BarberOdean2001}.}
...
The available evidence from recent European equity FTTs does not support the claim that low-rate transaction taxes mechanically increase volatility. Studies of the French FTT find no statistically significant increase in volatility after the introduction of the tax, despite a reduction in trading volumes \citep{Gomber2016,Meyer2015,CapelleBlancardHavrylchyk2016,ColliardHoffmann2017}. This result is robust across several empirical analyses using different control groups, time windows and data frequencies. Similar evidence from Italy and Spain also does not point to a major deterioration in market quality following the introduction of equity FTTs \citep{HvozdykRustanov2016,Cappelletti2017,Fuertes2024}.
...
This point also connects with a broader literature on the hidden costs of excessive liquidity and investor short-termism. Theoretical work has long emphasised that very liquid markets may weaken shareholders' incentives to monitor firms, because dissatisfied investors can exit rather than exercise control \citep{Coffee1991,Bhide1993}. Empirical studies similarly show that short investment horizons and high portfolio turnover can be associated with managerial myopia, lower long-term investment, reduced R\&D, distorted investment decisions and stronger price pressures during market shocks \citep{Bushee1998,AghionVanReenenZingales2013,DerrienKecskesThesmar2013,CellaEllulGiannetti2013,CremersPareekSautner2020,GarelPetitRomec2017}. The relevant issue is therefore not simply whether the tax is capitalised into prices, but whether it changes the balance between short-term trading and long-term ownership in a way that harms or improves firms' financing conditions.

This is why the empirical evidence on liquidity is decisive. The theoretical link between liquidity and expected returns is well established \citep{AmihudMendelson1986,Amihud2002}. But the empirical relevance of this channel for a low-rate equity transfer tax is much less clear. Evidence on the French FTT shows that trading volumes declined, but the effects on market quality were limited and did not provide evidence of a large disruption to liquidity. If the liquidity channel is weak or breaks at this stage, there is little reason to expect a material effect on firms' cost of capital.
...
This is an important concern, but it is also one of the reasons for limiting the proposal to equity ownership transfers. As explained above, the tax can rely on existing settlement, reporting and securities-registration infrastructures, rather than on a wholly new administrative system. The UK stamp duty and the French FTT show that such taxes are technically feasible.\footnote{The administrative challenge would be greater for possible extensions, especially to intraday transactions, derivatives, foreign exchange or crypto-assets. This is why these extensions are not included in the core proposal.}
...
These extensions may also be relevant for the political treatment of existing national FTTs. Countries that already tax equity transfers could use them to broaden their own national base, or the EU could consider them at a later stage once the core equity-transfer tax has been established. This would preserve the simplicity of the initial own-resource proposal while recognising that, from an economic point of view, there are good reasons not to leave intraday transactions and close equity-derivative substitutes permanently outside the tax base.
...
\subsection*{Sources and construction of Table~\ref{tab:existing_ftt}}

The table is based primarily on official tax-administration, budgetary and market-infrastructure sources. For each jurisdiction, the legal scope and rates were checked against the relevant tax authority, legislation, stock exchange or central securities depository documentation. Revenue figures are reported only when a reasonably identifiable official or quasi-official figure is available. They are converted into euros only to provide an order of magnitude and should not be interpreted as harmonised or directly comparable fiscal data.

The classification is deliberately conservative. A country is marked as covering equity when shares or comparable equity securities are part of the main effective tax base. Bonds and derivatives are reported separately because they raise different design and valuation issues. Formal or marginal components, such as high-frequency trading provisions or narrowly defined derivatives taxes, are not treated as equivalent to a broad-based tax on those instruments.

\begin{description}
\item France: \href{https://www.assemblee-nationale.fr/dyn/opendata/RINFANR5L17B1888.html}{Assemblée nationale, report on the French financial transaction tax}, reporting a 2024 yield of EUR 1,860 million. 

\item Italy: indicative figure around EUR 0.5 billion, based on recent Italian public reporting and budget discussions. This figure should be treated cautiously unless replaced by a fully comparable MEF revenue series. 

\item Belgium: \href{https://data-explorer.oecd.org/}{OECD Revenue Statistics 2025}, Belgium detailed country table, ``Tax on stock exchange transactions'', EUR 429 million in 2023. 

\item Ireland: \href{https://www.revenue.ie/en/corporate/press-office/annual-report/2025/ar-2025.pdf}{Revenue Commissioners, Annual Report 2025}, ``Stamp Duty on Shares'', EUR 540 million. 

\item United Kingdom: \href{https://www.gov.uk/government/statistics/uk-stamp-tax-statistics/uk-stamp-tax-statistics-2023-to-2024-commentary}{HMRC, Annual Stamp Tax Statistics 2024 to 2025}, stamp taxes on shares and other liable securities, GBP 4,320 million. 

\item Finland: Finnish Tax Administration, transfer tax guidance. The general rate for corporate stock
and other securities is 1.5\%, but purchases of listed shares on the stock exchange are usually
exempt. Purchases of listed shares outside the stock exchange may remain taxable at 1.5\%.
\url{https://www.vero.fi/en/individuals/property/transfer-tax/corporate-stock/}

\item Switzerland: \href{https://www.estv.admin.ch/}{Federal Tax Administration, 2025 activity report}, securities transfer stamp tax (Umsatzabgabe), CHF 1.534 billion. 

\item Hong Kong: \href{https://www.info.gov.hk/gia/general/202510/22/P2025102100678.htm}{Hong Kong Inland Revenue Department / Government of Hong Kong}, stamp duty collection from stock transactions, HKD 52 billion in 2024--25. 

\item South Korea: \href{https://korea.nabo.go.kr/}{National Assembly Budget Office, 2024 National Tax Revenue Performance and Causes of Changes}, securities transaction tax revenue, KRW 4.8 trillion. 

\item China: \href{https://en.theorychina.org.cn/c/2025-03-14/1522306.shtml}{Report on China's central and local budgets}, securities transaction stamp duty revenue, RMB 127.588 billion in 2024. 

\item Taiwan: \href{https://service.mof.gov.tw/public/Data/statistic/bulletin/114/Analysis\%20of\%20Tax\%20Collection\%20in\%202024.pdf}{Ministry of Finance, Analysis of Tax Collection in 2024}; securities transaction tax increased by NT\$90.7 billion, implying total revenue of around NT\$288 billion. 

\item India: \url{https://incometaxindia.gov.in/}{Government of India, Income Tax Department}, direct tax collection release for FY2024--25 as of 17 December 2024, reporting Securities Transaction Tax collection of INR 40,114 crore. 

\item United States: Securities and Exchange Commission, Section 31 transaction fee guidance and FY2026 fee-rate advisory. Section 31 fees are paid by national securities exchanges and national securities associations on covered sales, and are calibrated to produce fee collections equal to the SEC's regular appropriation. Certain listed put and call options issued by the Options Clearing Corporation are covered, with the fee computed on the option premium, whereas options on security indexes are excluded. The FY2026 rate is USD 20.60 per USD 1,000,000 of covered sales from 4 April 2026.
\url{https://www.sec.gov/rules-regulations/fee-rate-advisories/section-31-transaction-fees-basic-information-firms}  
