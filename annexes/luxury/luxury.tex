...
Individual Consumption Tax applies to watches and bags above roughly EUR~1{,}300 and to
...
roughly EUR~65{,}000; China's at roughly EUR~110{,}000; and Greece's at EUR~17{,}000.
...
much higher threshold of roughly EUR~156{,}000 to vessels.
...
\]
The revenue generated by the EU-wide tax is increasing in $t_{EU}$ and approaches EUR~322 billion as the rate goes to infinity. 
...
At an additive EU-wide luxury tax of $t_{EU}=0.4$, revenue would be EUR~80 billion. 

At $t_{EU}=0.6$, it would be EUR~106 billion. 
